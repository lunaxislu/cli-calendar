 ...
 * @returns
 */
function getMiniModeMonthMembershipStatus(month: Dayjs, currentDate: Dayjs) {
 ...
 */
function getMiniModeDateRelativeToToday(day: Dayjs) {
  const today = dayjs();
 ...
 * @params currentDate: The current date in the calendar (Dayjs)
 */
function getMiniModeCalendarDisplayState(month: Dayjs, currentDate: Dayjs) {
  return month.isSame(currentDate, "M")
 ...
 * @params day: The selected date (Dayjs)
 */
function getMiniModeDayType(day: Dayjs) {
...
export {
  getMiniModeCalendarDisplayState,
  getMiniModeMonthMembershipStatus,
  getMiniModeDateRelativeToToday,
  getMiniModeDayType,
};
