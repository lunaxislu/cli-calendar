...
function getBigModeMonthMembershipStatus(month: Dayjs, currentDate: Dayjs) {
 ...
 */
//
function getBigModeDateRelativeToToday(day: Dayjs) {
  const today = dayjs();
...
export { getBigModeDateRelativeToToday, getBigModeMonthMembershipStatus };
